...
(function waitForProtocol() {
  var waitInterval = setInterval(function () {
    var protocolReady = !!window.protocol;
    if (protocolReady) {
      if (!isMobile) {
        initBotmaker();
      } else {
...
function renderWppButton() {
  ...
  img.src = "https://wb.zoss.com.br/yappy/whatsapp.png";
...
function openWpp() {
  ...
  var wppMsg = protocol
    ? "Olá, meu número de protocolo é [" +
      protocol +
      "] e gostaria de aceitar o convite para fazer uma avaliação na Yappy!"
    : "Olá, gostaria de aceitar o convite para fazer uma avaliação na Yappy!";
  var encoded = encodeURIComponent(wppMsg);
  return window.open(
    "https://api.whatsapp.com/send?phone=5511998457623&text=" + encoded,
    "_blank"
  );
}
