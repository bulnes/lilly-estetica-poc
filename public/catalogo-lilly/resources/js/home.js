function displayCover() {
  ...
  const containerDisplayCover = document.querySelector(
    ".container-display-cover"
  );

  const containerDisplayHome = document.querySelector(
    ".container-display-home"
  );
  ...
  containerDisplayCover.addEventListener("click", () => {
    window.location.href = "/catalogo-lilly/index.html?home=1";
  });
}
...
function displayVideoPaollaOliveira() {
  ...
  const whatsappLinkContainer = document.querySelector(
    ".whatsapp-link-container"
  );

  const linkToPlayVideoContainer = document.querySelector(
    ".link-to-play-video-container"
  );

  const linkToPlayVideoContainerMobile = document.querySelector(
    ".link-to-play-video-container-mobile"
  );

  const videoPaollaContainer = document.querySelector(
    ".video-paolla-container"
  );

  const closedVideoPaollaBtn = document.querySelector(
    ".closed-video-paolla-btn"
  );
